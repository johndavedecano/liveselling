 ...
 */
exports.postUpdateStream = (req, res, next) => {
  User.findById(req.user.id, (err, user) => {
    ...
    user.profile.streamKey = streamKey

    user.profile.streamSecret = md5(process.env.SESSION_SECRET + streamKey)
...
exports.postSignup = (req, res, next) => {
  ...
  if (validator.isEmpty(req.body.name))
    validationErrors.push({ msg: 'Owner name field is required.' })

  if (validator.isEmpty(req.body.storeName))
    validationErrors.push({ msg: 'Store name field is required.' })
  ...
  user.profile.storeName = req.body.storeName
 ...
 */
exports.postUpdatePicture = (req, res, next) => {
  User.findById(req.user.id, (err, user) => {
    if (!req.file) {
      req.flash('success', {
        msg: 'Profile information has been updated.',
...
exports.postUpdateProfile = (req, res, next) => {
  ...
  User.findById(req.user.id, (err, user) => {
    ...
    user.profile.storeName = req.body.storeName || ''
    user.profile.storeDescription = req.body.storeDescription || ''
    user.profile.storeLon = req.body.storeLon || ''
    user.profile.storeLat = req.body.storeLat || ''
...
exports.getVerifyEmail = (req, res, next) => {
  ...
  const sendVerifyEmail = (token) => {
    ...
    const mailOptions = {
      ...
      subject: 'Please verify your email address on Live Tindahan',
      text: `Thank you for registering with live-tindahan.\n\n
...
exports.postReset = (req, res, next) => {
  ...
  const sendResetPasswordEmail = (user) => {
    ...
    const mailOptions = {
      to: user.email,
      from: 'hackathon@starter.com',
      subject: 'Your Live Tindahan password has been changed',
...
exports.postForgot = (req, res, next) => {
  ...
  const sendForgotPasswordEmail = (user) => {
    ...
    const mailOptions = {
      to: user.email,
      from: 'hackathon@starter.com',
      subject: 'Reset your password on Live Tindahan',
